...
const Search = () => {
  return (
    <div className="grid gap-4 md:grid-cols-4 lg:grid-cols-6 sm:grid-rows-2">
      ...
      <select
        className="outline-none hidden sm:block text-xs bg-[#F3F3F3] px-4 rounded-xl border-r-8 border-[#F3F3F3] font-bold"
        name="cars"
        id="cars"
      ...
      <select
        className="outline-none hidden sm:block text-xs bg-[#F3F3F3] px-4 rounded-xl border-r-4 border-[#F3F3F3] font-bold"
        name="cars"
        id="cars"
        style={{ borderRightWidth: "20px" }}
      >
